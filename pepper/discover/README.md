...
El núcleo aporta `pepper export --manifest <manifest-externo> --check` para que el agente se auto-verifique antes de entregar sin confiar en el manifest que vive dentro de su propio directorio.
