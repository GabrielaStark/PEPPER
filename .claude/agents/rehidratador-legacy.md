...
- **Configuración**: datasources, propiedades y variables se toman de los artefactos reales; nada inventado. Si el artefacto espera `10.4.2.186:5432/app_externo` con usuario `postgres`, el compose crea una red con ese subnet, pone la base en esa IP con ese nombre y ese rol, y restaura el respaldo ahí — aunque el respaldo venga con otro nombre de base.
